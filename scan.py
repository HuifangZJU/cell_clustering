...
FLAGS.add_argument('--config_exp', default='configs/scan_vizgen.yml', help='Location of experiments config file')
FLAGS.add_argument('--ds_rate',default=16,type=int,
                    help='data downsample rate')
FLAGS.add_argument('--batch_size',default=128,type=int,
                    help='data batchsize')
