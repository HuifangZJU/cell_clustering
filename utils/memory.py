...
class MemoryBank(object):
    def __init__(self, n, dim, num_classes, temperature):
        ...
        self.position_x = torch.FloatTensor(self.n)
        self.position_y = torch.FloatTensor(self.n)
        self.ptr = 0
        self.device = 'cpu'
        self.K = 100
    ...
    def update(self, features, position_x,position_y, targets):
        b = features.size(0)
        
        assert(b + self.ptr <= self.n)
        
        self.features[self.ptr:self.ptr+b].copy_(features.detach())
        self.position_x[self.ptr:self.ptr + b].copy_(position_x.detach())
        self.position_y[self.ptr:self.ptr + b].copy_(position_y.detach())
    ...
    def to(self, device):
        ...
        self.position_x = self.position_x.to(device)
        self.position_y = self.position_y.to(device)
        self.device = device
