...
FLAGS.add_argument('--config_exp',default='configs/scan/scan_vizgen.yml', help='Location of config file')
FLAGS.add_argument('--model', default='/home/huifang/workspace/experiment/scan/vizgen/scan/model.pth.tar', help='Location where model is saved')
...
def main():
    ...
    config['batch_size'] = 128 # To make sure we can evaluate on a single 1080ti
    # print(config)
    ...
    if config['setup'] in ['simclr', 'moco']:
        ...
        np.save('/home/huifang/workspace/experiment/scan/vizgen/scan/train_predictions.npy', labels.numpy())
        np.save('/home/huifang/workspace/experiment/scan/vizgen/scan/train_features.npy', features.numpy())
